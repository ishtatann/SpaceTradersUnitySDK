...
namespace SpaceTradersUnitySDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ScrapTransaction")]
    public partial class ScrapTransaction : IEquatable<ScrapTransaction>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScrapTransaction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ScrapTransaction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ScrapTransaction" /> class.
        /// </summary>
        ...
        public ScrapTransaction(string waypointSymbol = default(string), string shipSymbol = default(string), int totalPrice = default(int), DateTime timestamp = default(DateTime))
        {
            ...
            {
                throw new ArgumentNullException("waypointSymbol is a required property for ScrapTransaction and cannot be null");
            }
            this.WaypointSymbol = waypointSymbol;
            // to ensure "shipSymbol" is required (not null)
            if (shipSymbol == null)
            {
                throw new ArgumentNullException("shipSymbol is a required property for ScrapTransaction and cannot be null");
            }
