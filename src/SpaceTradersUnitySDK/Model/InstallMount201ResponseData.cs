...
namespace SpaceTradersUnitySDK.Model
{
    ...
    public partial class InstallMount201ResponseData : IEquatable<InstallMount201ResponseData>
    {
        ...
        public InstallMount201ResponseData(Agent agent = default(Agent), List<ShipMount> mounts = default(List<ShipMount>), ShipCargo cargo = default(ShipCargo), InstallMount201ResponseDataTransaction transaction = default(InstallMount201ResponseDataTransaction))
        {
        ...
        public InstallMount201ResponseDataTransaction Transaction { get; set; }
