...
namespace SpaceTradersUnitySDK.Model
{
    ...
    public partial class InstallMount201Response : IEquatable<InstallMount201Response>
    {
        /// <summary>
        ...
        public InstallMount201Response(InstallMount201ResponseData data = default(InstallMount201ResponseData))
        {
            ...
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for InstallMount201Response and cannot be null");
            }
            this.Data = data;
        }
